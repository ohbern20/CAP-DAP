...
```{r}
ferns_forest_glm <- glm(Percent_ferns ~ Forest, data = ferns, family = gaussian()) #gaussian family has a "identiy" link and assumes normal distribution
```
...
## Statistical Test 4: Regen count between Peavine and Degrasse (chi squared)
