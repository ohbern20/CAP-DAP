...
Decide on statistical test: I will use a linear regression since the predictor variable (canopy density) is somewhat continuous, and the response variable (regeneration) is also somewhat continuous. 
...
Because the predictor (canopy density) is continuous but bounded between 0-100, and the response (percent bare ground) is continuous, I will use a generalized linear model. 
